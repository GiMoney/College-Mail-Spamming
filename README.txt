...
3. Type in the instal commond on node.js
...
8. Save that shit and Open your Terminal
9. Use your unix commands (cd) to where your ide holds the files you put in it.
10.Now that you are at the right directory, type the command 'node index.js' ( not including the ')
